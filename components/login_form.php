...
<form action="index.php" method="POST" class="space-y-6">
    <div>
        <label class="block text-sm font-medium text-resto-dark mb-2">Username</label>
        <div class="relative">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <i class="fas fa-user text-resto-gray"></i>
            </div>
    ...
    <div>
        <label class="block text-sm font-medium text-resto-dark mb-2">Password</label>
        <div class="relative">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <i class="fas fa-lock text-resto-gray"></i>
            </div>
            ...
            <button type="button" id="toggle-password" class="absolute inset-y-0 right-0 pr-3 flex items-center">
                <i class="fas fa-eye text-resto-gray"></i>
            </button>
        </div>
    </div>

    <button type="submit" class="w-full bg-resto-primary text-white py-3 px-4 rounded-lg font-semibold hover:bg-orange-600 transition duration-300 focus:ring-2 focus:ring-orange-500">
